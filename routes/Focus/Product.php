 ...
 */
    Route::group(['namespace' => 'product'], function () {
        ...
        //Route::get('variation/stock_transfer', 'ProductsController@showStockTransfer')->name('variation.stock_transfer');
        ...
        Route::post('variation/get', 'ProductsTableController@variationTable')->name('variation.get');
