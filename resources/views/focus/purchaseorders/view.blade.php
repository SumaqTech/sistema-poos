                    ...
                    <div id="invoice-template" class="card-body">
                        <div class="row">
                            ...
                            <span
                                    ...
                                    <a href="https://api.whatsapp.com/send?phone={{$purchaseorder->customer->phone}}&text={{message_body(5,17,$purchaseorder,$link,trans('purchaseorders.purchaseorder'))}}" class="btn btn-success mb-1" target="_blank"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-sm-12">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <img src="{{ Storage::disk('public')->url('/img/signs/' . $purchaseorder->user->signature) }}"
